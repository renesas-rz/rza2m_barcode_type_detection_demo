 ...
 *********************************************************************************************************************/
extern char   octa_bss_start __asm ("__bss_on_octa_start");    /* Defined by the linker.  */
extern char   octa_bss_end   __asm ("__bss_on_octa_end");
...
void Userdef_PostHardwareSetup(void)
{
    ...
    {
    	int octa_bss_len = &octa_bss_end - &octa_bss_start;
    	memset(&octa_bss_start, 0, octa_bss_len);
    }
}
#endif
/**********************************************************************************************************************
