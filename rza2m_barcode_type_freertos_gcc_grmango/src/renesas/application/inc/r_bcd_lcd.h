...
#define R_BCD_LCD_WIDTH     (R_BCD_CAMERA_WIDTH/DRP_RESIZE)
#define R_BCD_LCD_HEIGHT    (R_BCD_CAMERA_HEIGHT/DRP_RESIZE)
#define R_BCD_LCD_STRIDE    (32u)

//Display Execution Time
#define R_BCD_LCD_WIDTH2     (800u)
#define R_BCD_LCD_HEIGHT2    (240u)

//Display Rectangle
#define R_BCD_LCD_WIDTH3     (R_BCD_CAMERA_WIDTH/DRP_RESIZE)
#define R_BCD_LCD_HEIGHT3    (R_BCD_CAMERA_HEIGHT/DRP_RESIZE)
...
#define     LAYER2_DISP_AREA_VS         (600u-R_BCD_LCD_HEIGHT2) //For 800x600 case
#define     LAYER2_DISP_AREA_HW         (R_BCD_LCD_WIDTH2)
#define     LAYER2_DISP_AREA_VW         (R_BCD_LCD_HEIGHT2)
...
#define     LAYER3_DISP_AREA_HS         (0u)
#define     LAYER3_DISP_AREA_VS         (0u)
#define     LAYER3_DISP_AREA_HW         (R_BCD_LCD_WIDTH3)
#define     LAYER3_DISP_AREA_VW         (R_BCD_LCD_HEIGHT3)

#define     GRAPHICS3_BUFFER_STRIDE     (((LAYER3_DISP_AREA_HW / 2) + (R_BCD_LCD_STRIDE - 1)) & ~(R_BCD_LCD_STRIDE - 1))
#define     GRAPHICS3_BUFFER_HEIGHT     (LAYER3_DISP_AREA_VW)
#define     GRAPHICS3_BUFFER_NUM        (2u)
