 ...
 *********************************************************************************************************************/
extern char   hyper_bss_start __asm ("__bss_on_hyper_start");    /* Defined by the linker.  */
extern char   hyper_bss_end   __asm ("__bss_on_hyper_end");
...
void Userdef_PostHardwareSetup(void)
{
    ...
    {
    	int hyper_bss_len = &hyper_bss_end - &hyper_bss_start;
    	memset(&hyper_bss_start, 0, hyper_bss_len);
    }
}
#endif
/**********************************************************************************************************************
